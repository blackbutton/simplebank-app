...
const deleteAccountEntry = `-- name: DeleteAccountEntry :exec
DELETE FROM entries
WHERE account_id = $1
`

func (q *Queries) DeleteAccountEntry(ctx context.Context, accountID int64) error {
	_, err := q.db.ExecContext(ctx, deleteAccountEntry, accountID)
	return err
}
